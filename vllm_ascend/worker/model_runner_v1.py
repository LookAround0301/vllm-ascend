...
class NPUModelRunner(LoRAModelRunnerMixin):
    ...
    def _update_states(self, scheduler_output: "SchedulerOutput") -> None:
        ...
        for new_req_data in scheduler_output.scheduled_new_reqs:
            ...
            req_state = CachedRequestState(
                ...
                num_computed_tokens_of_pcp_dcp=None,
            ...
            if self.pcp_size * self.dcp_size > 1:
                ...
                if num_computed_tokens > 0:
                    ...
                    req_state.num_computed_tokens_of_cp_sp_single = [[0] * self.dcp_size for _ in range(self.pcp_size)]
                    req_state.num_computed_tokens_of_cp_sp_accum = []
        ...
        for i, req_id in enumerate(req_data.req_ids):
            ...
            self.input_batch.num_computed_tokens_of_pcp_dcp[req_index] = req_state.num_computed_tokens_of_pcp_dcp
    ...
    def _generate_pcp_metadata(self, total_num_scheduled_tokens, seq_lens, seq_lens_origin):
        num_reqs = self.input_batch.num_reqs
        ...
        if self.pcp_size * self.dcp_size > 1:
            long_seq_metadata = AscendPrefillContextParallelMetadata(
                ...
                num_computed_tokens_of_cp_sp_single=self.input_batch.num_computed_tokens_of_cp_sp_single[
                                                    :self.input_batch.num_reqs],
                num_computed_tokens_of_cp_sp_current=self.input_batch.num_computed_tokens_of_cp_sp_current[
                                                     :self.input_batch.num_reqs],
