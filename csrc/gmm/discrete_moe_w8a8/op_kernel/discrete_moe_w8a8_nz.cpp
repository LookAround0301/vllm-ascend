...
// Exactly one kernel per translation unit: CANN's direct-build metadata for
// additional kernels in a file is not reliable on the supported CANN version.
#include "discrete_moe_w8a8_kernel.h"

extern "C" __global__ __aicore__ void discrete_gmm_nz_kernel(
...
{
    return discrete_gmm_nz_kernel<<<cores, nullptr, stream>>>(
